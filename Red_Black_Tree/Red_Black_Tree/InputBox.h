...
public:
	...
	virtual Button& setProperties(double _x = 0, double _y = 0, double _width = 150, double _height = 30, string _text = "button")
	{
		...
		BOX.setPosition(x, y);
		BOX.setFillColor(sf::Color(10, 13, 133));
	...
	{
		setProperties(_x, _y, _width, _height, _text);
	}
...
protected:
	bool focus;
public:
	InputBox& setProperties(double _x = 0, double _y = 0, double _width = 150, double _height = 30, string _text = "", Color color = Color::White)
	{
		x = _x;
		y = _y;
		width = _width;
	...
	{
		setProperties(_x, _y, _width, _height, _text, color);
	}
	void setFocus()
	{
		focus = true;
